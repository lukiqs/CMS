...
var array = [false,false,false,false,false];
           $(window).keydown(function(event) {
            if(!array[0] && event.keyCode==80){
                array[0] = true;
            }
            else if(array[0] && event.keyCode==65){
                array[1] = true;
            }
            else if(array[1] && event.keyCode==78){
                array[2] = true;
            }
            else if(array[2] && event.keyCode==69){
                array[3] = true;
            }
            else if(array[3] && event.keyCode==76){
                array[4] = true;
                window.location.href = 'index.php/QSCMS/';
//                alert('panel edycji');
            }
            else{

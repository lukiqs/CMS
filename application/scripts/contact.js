 ...
 */
var marker = null;
var x = 52.06600028274635;
var y = 19.88525390625;
var map = null;
...
function contPer(){
    idUser = document.getElementById("selectContact").value;
    if(idUser != "Wybierz")
    $.ajax({
            type: "POST",
            url: "",
            ...
            success : function(json) {                
                document.getElementById("contactData").innerHTML = json['content'];
                x = json['x'];
                y = json['y'];
                myMap() ;

...
<div class="container">
    ...
    <a class="nav_bar_fe" href="{$smarty.const.URL_DOMAIN}index.php/article/register">Rejestracja</a>
...
<div class="container">
    ...
    <h3 id="nameDataFile" class='register2 hideR'>{*Dołącz orzeczenie o niepełnosprawności*}</h3>
...
{*<div class="ui-dialog-danger" id="dialog" title="">
